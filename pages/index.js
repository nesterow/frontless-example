...
riot.install(function(component) {
  ...
  component.onMounted = function(props, state) {
    EventBus.removeEventListener(
      eventName,
      component.onServerState.bind(this),
      component
    );
...
const tags = require("./**/*.riot", { mode: "list" }).concat(
...
const initialize = () => {
  tags.forEach(tag => {
    ...
    if (component.exports) {
      ...
      component.exports = () => {
        ...
        initilaExports.state =
          STATE[initilaExports.id || component.name] || initilaExports.state;
  ...
  if (root) {
    ...
    const ComponentImplementation = tags.find(
      tag => tag.module.default.name === root.getAttribute("is")
    );
...
// })
document.addEventListener("hmr:updated", () =>
